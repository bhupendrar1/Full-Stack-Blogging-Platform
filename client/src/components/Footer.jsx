...
return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3 '>
        ...
        py-10 border-b border-gray-500/30 text-gray-500'>
            ...
            <p className='max-w-[410px] mt-6'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non, excepturi? Porro sint.
            </p>
            </div>
    ...
    > Copyright 2026 &copy; QuickBlog - All Rights Reserved.</p>
    </div>
